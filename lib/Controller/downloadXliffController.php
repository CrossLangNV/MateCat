 ...
 *
 */
class downloadXliffController extends ajaxController {
    ...
    public function __construct() {
        ...
        if ( !$this->userIsLogged ) {
            ...
            Utils::sendErrMailReport( $output, "Download Xliff Error: user Not Logged" );
            exit;
        }

        $this->xliffHandler = new TMSService();
        $this->xliffHandler->setTmKey( $this->tm_key );
        $this->xliffHandler->setName( $this->tm_name );
    ...
    function doAction() {
        ...
        try {
            ...
            $this->result[ 'data' ] = $this->xliffHandler->requestXliffEmailDownload(
