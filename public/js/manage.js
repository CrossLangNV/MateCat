    ...
    downloadTranslation: function(project, job, urlWarnings) {
        ...
        if ( job.warnings_count > 0 ) {
            var props = {
                ...
                '<a style="color: #D32A3A; font-weight: 700; text-decoration: underline;" href="https://www.matecat.com/support/advanced-features/understanding-fixing-tag-errors-tag-issues-matecat/" target="_blank">How to fix tags in MateCat </a> <br /><br />'+
